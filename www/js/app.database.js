function createTables($cordovaSQLite) {
  ...
  var methods = "CREATE TABLE IF NOT EXISTS writing_methods (id integer primary key, writing_method_id_api integer, name text, created_at text, updated_at text, code integer)";
