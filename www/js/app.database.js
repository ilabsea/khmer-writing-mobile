function createTables($cordovaSQLite) {
  ...
  var lessons = "CREATE TABLE IF NOT EXISTS lessons (id integer primary key, lesson_id_api integer, name text, grade_id_api integer, created_at text, updated_at text, khmer_numeric text, background text)";
